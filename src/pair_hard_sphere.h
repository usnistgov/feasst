...
class PairHardSphere : public Pair {
 public:
  ...
  // The reduction factor is used for intramolecular interactions in the mab
  // models. It is a simple way to reduce the sigma parameters.
  void setReductionFactor(const double factor = 1.) {
    reduction_factor_ = factor; }
