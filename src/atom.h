...
class Atom : public BaseRandom {
 public:
  ...
  /// Return if default value for integer when unassigned.
  int defaultInt() const { return defaultInt_; }
 ...
 protected:
  ...
  /// Assign default value to later check if it has been reassigned
  int defaultInt_ = -75678042;
