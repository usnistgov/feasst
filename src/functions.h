...
/// Return the closest distance of a point, x0, to an axis defined by two
/// points (x1, x2)
/// http://mathworld.wolfram.com/Point-LineDistance3-Dimensional.html
double closestDistancePointToAxis(const vector<double> &x0,
  const vector<double> &x1, const vector<double> &x2);

/// Return the point closest to x0 which is on a line(defined by x1,x2).
/// http://mathworld.wolfram.com/Point-LineDistance3-Dimensional.html
