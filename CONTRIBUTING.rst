...
* implement all functionality of TrialAdd/Delete within TrialConfigBias, retire previous versions of Trial[Add,Delete,AVB], then possibly break up TrialConfigBias.
* disabled PBCs need corresponding wrap disabled
* refactor AVB for multicomponent
