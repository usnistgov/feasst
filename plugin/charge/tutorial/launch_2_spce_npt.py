...
def post_process(params):
    ...
    assert np.abs(rhos[0][0] - 800) < 20
    assert np.abs(rhos[1][0] - 850) < 20
    assert np.abs(rhos[2][0] - 900) < 20
    assert np.abs(rhos[3][0] - 950) < 20
    assert np.abs(rhos[4][0] - 990) < 20
    assert np.abs(rhos[5][0] - 995) < 20
    assert np.abs(rhos[6][0] - 1000) < 20
    assert np.abs(rhos[7][0] - 1005) < 20
    assert np.abs(ens[0][0] + 8.362) < 0.1
    assert np.abs(ens[1][0] + 8.565) < 0.1
    assert np.abs(ens[2][0] + 8.758) < 0.1
    assert np.abs(ens[3][0] + 8.934) < 0.1
    assert np.abs(ens[4][0] + 9.064) < 0.1
    assert np.abs(ens[5][0] + 9.078) < 0.1
    assert np.abs(ens[6][0] + 9.095) < 0.1
    assert np.abs(ens[7][0] + 9.108) < 0.1
