...
def post_process(params):
    ...
    assert np.abs(gr['gLJ-LJ'][45] - 1.2829) < 0.05
    ...
    gr_scaled = gr['gLJ-LJ']/np.average(gr['gLJ-LJ'][int(0.95*len(gr['r'])):])
    plt.plot(gr['r'], gr['gLJ-LJ'], label='gr')
    ...
    for q in qs:
        ...
        sq.append(scattering.structure_factor(gr['r'], gr['gLJ-LJ'], frequency=q, number_density=number_density))
