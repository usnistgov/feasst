...
TEST(Bond, serialize) {
  ...
  Bond bond2 = test_serialize(bond, "847 1 1 banana 1 12 8896 45 Bond 743 2 12 1 0 ");
...
TEST(Angle, serialize) {
  ...
  Angle angle2 = test_serialize(angle, "847 1 1 banana 1 12 8896 45 Angle 743 2 12 1 0 ");
