...
TEST(ParticleFactory, site_types) {
  ...
  particles.add(FileParticle().read("../particle/atom.txt"));
  particles.add(FileParticle().read("../particle/spce.txt"));
  ...
  TRY(
    particles.add("../particle/atom.txt");
...
TEST(ParticleFactory, unique_particles) {
  ...
  particles.add("../particle/atom.txt");
  particles.add("../particle/spce.txt");
