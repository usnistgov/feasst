...
MoviePatch     trials_per_write {tpi} output_file {prefix}n{node}s[sim_index]_eq.xyz stop_after_iteration 1
MoviePatch     trials_per_write {tpi} output_file {prefix}n{node}s[sim_index].xyz start_after_iteration 1
