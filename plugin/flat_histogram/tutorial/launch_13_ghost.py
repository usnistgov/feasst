"""
Conduct ghost insertions during a two-macrostate flat-histogram simulation to compare the methodology.
"""
...
GhostTrialGrow trials_per_update 10 trials_per_write {trials_per_iteration} file_name {prefix}n{node}s[sim_index]_ghost.txt trial_grow_file {prefix}_ghost_insertion.txt multistate true
