...
AnalyzeCluster trials_per_write {tpi} output_file {prefix}n{node}s[sim_index]_cluster_eq.txt multistate true stop_after_iteration 100
AnalyzeCluster trials_per_write {tpi} output_file {prefix}n{node}s[sim_index]_cluster.txt multistate true start_after_iteration 100
