...
The convergence of the macrostate distrubtion function in the ljj0_lnpi.txt files is also a way to monitor the simulations.
...
# continue until all simulations in the job are complete
...
def post_process(params):
    ...
    en = multistate_accumulator.splice(prefix=params['prefix']+'j', suffix='_en.csv')
    ...
    srsw_eq=pd.read_csv('../../../plugin/flat_histogram/test/data/lj_srsw_equil.csv', comment='#')
