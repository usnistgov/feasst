...
particle_type=fluid add=true site=LJ1 num_steps=10
""")
...
TrialTransfer weight=2 particle_type=fluid
Log [write].csv
...
GhostTrialGrow [write]_ghost.csv trials_per_update=10 grow_file={prefix}_ghost_insertion.txt multistate=true
