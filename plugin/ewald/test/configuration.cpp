...
TEST(Configuration, synchronize) {
  ...
  EXPECT_NEAR(s1.configuration().particle(0).site(0).property("eikrx2"), 0.96822687154397247, NEAR_ZERO);
  ...
  EXPECT_NEAR(s2.configuration().particle(0).site(0).property("eikrx2"), 0.96822687154397247, NEAR_ZERO);
}
