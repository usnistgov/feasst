...
Movie output_file={prefix}j{job:03d}s{sim:03d}_pore.xyz group=pore clear_file=true
...
def post_process(params):
    import pandas as pd
    df=macrostate_distribution.splice_files(prefix=params['prefix']+'j', suffix='_crit.csv', shift=False).dataframe()
