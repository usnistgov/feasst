...
def parse():
    ...
    parser.add_argument('--num_jobs', type=int, default=16, help='Number of jobs in queue')
...
Movie output_file={prefix}j{job:03d}s{sim:03d}_MOF.xyz group=MOF clear_file=true
