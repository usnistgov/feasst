...
Movie trials_per_write {tpc} output_file {prefix}{node}s[sim_index]_eq.xyz stop_after_cycle 1 group fluid
Movie trials_per_write {tpc} output_file {prefix}{node}s[sim_index].xyz start_after_cycle 1 group fluid
