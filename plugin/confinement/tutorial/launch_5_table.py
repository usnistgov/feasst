"""
This is a simple test of a ModelTableCart1D as described in the previous tutorial but with a table potential.
"""
...
def parse():
    ...
    params['prefix'] = 'cart1d'
    params['sim_id_file'] = params['prefix']+ '_sim_ids.txt'
    params['minutes'] = int(params['hours_terminate']*60) # minutes allocated on queue
    params['hours_terminate'] = 0.95*params['hours_terminate'] - 0.05 # terminate FEASST before SLURM
    params['num_sims'] = params['num_nodes']
    params['procs_per_sim'] = params['procs_per_node']
    with open(params['prefix']+'_table_file.txt', 'w') as file1:
...
Potential Model=ModelTableCart1D dimension=0 table_file={prefix}_table_file.txt
