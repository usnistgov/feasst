...
.. code-block:: bash
    ...
    curl -OL https://github.com/usnistgov/feasst/archive/refs/tags/v0.25.14.tar.gz # download
    tar -xf v0.25.14.tar.gz           # uncompress
    mkdir feasst-0.25.14/build; cd $_ # out-of-source build
...
.. code-block:: bash
    ...
    $HOME/feasst-0.25.14/build/bin/fst < $HOME/feasst-0.25.14/tutorial/example.txt
