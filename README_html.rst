...
.. code-block:: bash
    ...
    curl -OL https://github.com/usnistgov/feasst/archive/refs/tags/v0.25.15.tar.gz # download
    tar -xf v0.25.15.tar.gz           # uncompress
    mkdir feasst-0.25.15/build; cd $_ # out-of-source build
...
.. code-block:: bash
    ...
    $HOME/feasst-0.25.15/build/bin/fst < $HOME/feasst-0.25.15/tutorial/example.txt
