...
%shared_ptr(feasst::Table4D);
%shared_ptr(feasst::Table5D);
%shared_ptr(feasst::Table6D);
...
%shared_ptr(feasst::PerturbConnector);
...
%shared_ptr(feasst::PerturbDistanceAngleConnector);
...
%shared_ptr(feasst::PerturbLibrary);
