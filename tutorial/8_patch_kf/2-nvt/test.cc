...
int main() {  // PatchKF, NVT
  ...
  // acceptance criteria and single particle moves
  ...
  feasst::addTrialTransform(&mc,
    {{"transType", "rotate"},
     {"maxMoveParam", "0.1"}});
  feasst::addTrialTransform(&mc, {{"transType", "line-reflect"}});
  feasst::addTrialTransform(&mc, {{"transType", "bond-reflect"}});
