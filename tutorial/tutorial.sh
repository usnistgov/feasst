...
# This process is demonstrated here with a short simulation.
...
cd \$PWD
python tutorial.py --task \$SLURM_ARRAY_TASK_ID --trials $trials
#./tutorial --task \$SLURM_ARRAY_TASK_ID --trials $trials
