...
int main() {  // SPCE, SRSW_REFCONF
  for (int srswConfig = 1; srswConfig <= 2; ++srswConfig) {
    ...
    ss << space->install_dir() << "/tutorial/3_spce/1_ref-config/spce_sample_config_periodic" << srswConfig << ".xyz";
    ...
    if (srswConfig == 1) {
      ...
      expect_near(pair->peLRC()*KJperMol2Kelvin, -823.71499511652326, 1e-11, "LRC");
      ...
      expect_near(pair->peLRC()*KJperMol2Kelvin, -3294.8599804660766, 1e-11, "LRC");
